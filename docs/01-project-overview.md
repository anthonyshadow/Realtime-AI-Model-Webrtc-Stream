...
- Bottom-center floating recording dock for active local and model-backed sessions, with post-recording review playback, download, and discard.
...
11. The recording hook consumes the selected `recordableStream` and the recording dock exposes record/stop-recording, review playback, download, and discard controls without owning Decart or stopping source tracks.
