...
- A completed recording remains available after the live session stops so the user can review, download, or discard it; starting another recording or confirming discard revokes the previous object URL.
